...
var (
	...
	FeeAddress   = hasharry.StringToAddress("UBCNQhgkNHCLdVhCFvpo6bGXXdcKtTTfeQZE")
...
var (
	MainPubKeyHashAddrID  = [3]byte{0x03, 0x82, 0x32} //UBC 3, 82, 32
	TestPubKeyHashAddrID  = [3]byte{0x03, 0x82, 0x32} //ubc
...
var MappingCoin = []MappingInfo{
	{
		Address: "UBCb4xr3SibFrTSijAJAkxxASfd7huzmik62",
		Note:    "",
		Amount:  210 * 1e4 * 1e8,
	},
}
