...
func init() {
	for _, s := range []string{
		...
		// UBCMVYnuSwfr5JaqrkdTSVr9UBCMVYnuSwfr5JaqrkdTSVr9aPqffovCEBjkaPqffovCEBjk
		"/ip4/180.188.198.214/tcp/2211/ipfs/16Uiu2HAmUjqmEBibYgTq8mHZWD38KJw17oXZtqEi4vPRxqCSTFSj",
	} {
